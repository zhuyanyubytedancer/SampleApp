...
#define IS_IPHONE_MAX (SCREEN_WIDTH == [GTScreen sizeFor65Inch].width && SCREEN_HEIGHT == [GTScreen sizeFor65Inch].height && [UIScreen mainScreen].scale == 3)


#define  STATUSBARHEIGHT （IS_IPHONE_X_XR_MAX ? 44:20)

#define UI(x) UIAdapter(float x)
